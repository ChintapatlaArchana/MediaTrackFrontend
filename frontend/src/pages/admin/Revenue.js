      ...
      const fetchRevenue = async () => {
         try {
            ...
            const [
               ...
               adminService.getNetAdds(),
               adminService.getMonthlyAdRevenueStats()
            ]);
               ...
               <div className="row g-4 mb-5">
                  <div className="col-md-3">
                     <div className="metric-card">
                        ...
                        <div className="metric-sub text-secondary">Monthly Revenue Rate</div>
                     </div>
                  </div>
                  <div className="col-md-3">
                     <div className="metric-card">
                        ...
                        <div className="metric-sub text-secondary">Annual Revenue Rate</div>
                     </div>
                  </div>
                  <div className="col-md-3">
                     <div className="metric-card">
