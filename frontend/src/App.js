...
import AdOpsManager from "./pages/adOps/AdOpsManager";
import CreateCampaign from "./pages/adOps/CreateCampaign";
import { AdminDashboard } from './pages/admin/AdminDashboard';
import ViewReports from "./pages/adOps/ViewReports";
import AllCampaigns from "./pages/adOps/AllCampaigns";
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/editor/upload" element={<UploadContent />}/>
      <Route path="/editor/schedule" element={<ScheduleRelease />}/>
      <Route path="/editor/library" element={<ContentLibrary />}/>
