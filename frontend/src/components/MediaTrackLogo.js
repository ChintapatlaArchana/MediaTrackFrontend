...
export const MediaTrackLogo = ({
  ...
  return (
    <div className={`media-track-logo ${className}`} style={{ display: "flex", alignItems: "center", gap }}>
      {/* ICON */}
      <svg
        width={size}
        height={size}
      ...
      {showText && (
        ...
        >
          <span style={{ color: "#FFFFFF", fontWeight: 600, fontSize: 20 }}>Media</span>
          <span style={{ color: "#B8B1D6", fontWeight: 600, fontSize: 20 }}>Track</span>
        </div>
      )}
    </div>
  );
